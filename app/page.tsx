...
const basePath = '/core-tech-1775799347095';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting', d: 'Our reliable and secure hosting services provide a solid foundation for businesses to establish a strong online presence, with scalable solutions to meet the needs of growing organizations. We offer a range of hosting options, from shared hosting to dedicated servers, to ensure that our clients\' websites and applications are always available and performing optimally.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Dev', d: 'Our web development services are designed to create custom, user-friendly, and responsive websites that drive business results, with a focus on converting visitors into customers. Our team of expert developers works closely with clients to understand their unique needs and goals, delivering tailored solutions that meet their specific requirements.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'App Dev', d: 'Our app development services empower businesses to reach new heights, creating innovative and engaging mobile applications that enhance customer experience and drive revenue growth. We develop apps for a range of platforms, including iOS and Android, and offer ongoing support and maintenance to ensure that our clients\' apps remain up-to-date and secure.', i: 'https://images.pexels.com/photos/54284/pexels-photo-54284.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain', d: 'Our domain registration services provide a simple and convenient way for businesses to establish a professional online presence, with a range of domain options to choose from and expert guidance to help clients select the perfect domain for their needs. We also offer domain management services, including renewals and transfers, to ensure that our clients\' domains remain secure and up-to-date.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Inquiries', d: 'Our inquiries service is designed to provide businesses with expert guidance and support, helping them to navigate the complex world of technology and make informed decisions about their IT needs. Our team of experts is available to answer questions, provide advice, and offer tailored solutions to meet the unique needs of our clients, from initial consultation to ongoing support and maintenance.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/18545016/pexels-photo-18545016.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we specialize in providing innovative technology solutions to meet the evolving needs of our clients. With a strong focus on customer satisfaction, we strive to deliver high-quality services that exceed expectations. Our team of experts is dedicated to helping businesses thrive in the digital age.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading technology solutions provider in Kuching, empowering businesses to succeed in a rapidly changing world.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver exceptional technology services that meet the unique needs of our clients, fostering long-term partnerships and driving business growth through innovation and expertise.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">Our \'Customer First\' approach ensures that we prioritize the needs and satisfaction of our clients, delivering personalized solutions that meet their specific requirements and goals.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">We embrace \'Innovation\' as a core value, continuously seeking new and better ways to leverage technology and improve our services, staying ahead of the curve to provide cutting-edge solutions to our clients.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/6804068/pexels-photo-6804068.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              ...
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/19895721/pexels-photo-19895721.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="bg-primary text-white rounded-2xl overflow-hidden shadow-2xl flex flex-col lg:flex-row">
            ...
            <div className="flex-1 p-12 lg:p-20 bg-secondary">
              <h2 className="font-headline text-4xl font-extrabold mb-8 tracking-tighter">Initiate a Project.</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          ...
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              &copy; {new Date().getFullYear()} Core Tech. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
